...
public class CustomerService implements ICustomerService {
    ...
    public void searchNameCustomer() {
        System.out.println("Nhập tên người dùng bạn cần tìm");
        String name = scanner.nextLine();
        if (customerRepository.searchNameCustomer(name) != null) {
            for (Customer customer : customerRepository.searchNameCustomer(name)) {
