...
public class MyListTest {
    public static void main(String[] args) {
        ...
        MyList<Integer> myList3 = new MyList<>(3);
        ...
        System.out.println("List 1 Contain 'Hai' " + myList1.isContains("Hai") + " Vị trí thứ " + myList1.indexOf("Hai"));
        System.out.println("List 1 Contain 'Năm' " + myList1.isContains("Năm"));
